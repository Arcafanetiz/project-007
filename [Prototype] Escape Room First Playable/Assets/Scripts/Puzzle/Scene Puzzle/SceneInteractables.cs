...
public class SceneInteractables : MonoBehaviour
{
    ...
    public enum AnimationType { NONE, SHAKE, DISSAPEAR, MOVEUP };
    ...
    public void MoveUp()
    {
        ...
        LeanTween.move(this.gameObject, this.transform.position + new Vector3(0.0f, animationDuration * 2.0f, 0.0f), animationDuration).setEase(LeanTweenType.easeOutExpo);
    }
